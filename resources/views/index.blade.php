						...
						<div class="tab2">
							 <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="/single">A-line Black Skirt</a></h4>
										<div class="info-product-price">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="/single">Skinny Jeans</a></h4>
										<div class="info-product-price">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="/single">Pink Track Pants</a></h4>
										<div class="info-product-price">
						    ...
						    <div class="col-md-3 product-men">
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="/single">Reebok Women's Tights</a></h4>
										<div class="info-product-price">
											<span class="item_price">$130.99</span>
											<del>$169.71</del>
										</div>
					 ...
					 <!--//tab_two-->
						...
						<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="/single">Laptop Messenger Bag</a></h4>
										<div class="info-product-price">
											<span class="item_price">$140.99</span>
											<del>$169.71</del>
										</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="/single">Puma Backpack</a></h4>
										<div class="info-product-price">
                            ...
                            <div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="/single"> Laptop Backpack</a></h4>
										<div class="info-product-price">
											<span class="item_price">$120.99</span>
											<del>$189.71</del>
										</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="/single">Travel Duffel Bag </a></h4>
										<div class="info-product-price">
											<span class="item_price">$190.99</span>
											<del>$259.71</del>
										</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="/single"> Hand-held Bag </a></h4>
										<div class="info-product-price">
											<span class="item_price">$190.99</span>
											<del>$259.71</del>
										</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="/single">Butterflies Bag </a></h4>
										<div class="info-product-price">
											<span class="item_price">$190.99</span>
											<del>$259.71</del>
										</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="/single">Costa Swiss Bag </a></h4>
										<div class="info-product-price">
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="/single">Noble Designs Bag </a></h4>
										<div class="info-product-price">
											<span class="item_price">$120.99</span>
											<del>$159.71</del>
										</div>
						...
						<div class="tab4">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="/single">Shoetopia Lace Up</a></h4>
										<div class="info-product-price">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="/single">Steemo Casuals(Black)</a></h4>
										<div class="info-product-price">
											<span class="item_price">$90.99</span>
											<del>$59.71</del>
										</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="/single">Benetton Flip Flops</a></h4>
										<div class="info-product-price">
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="/single">Moonwalk Bellies </a></h4>
										<div class="info-product-price">
											<span class="item_price">$80.99</span>
											<del>$99.71</del>
										</div>
							...
							<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="/single">Sparx Sporty Canvas Shoes</a></h4>
										<div class="info-product-price">
											<span class="item_price">$160.99</span>
											<del>$199.71</del>
										</div>
								...
								<div class="men-pro-item simpleCart_shelfItem">
									...
									<div class="item-info-product ">
										<h4><a href="/single">Women BLACK Heels</a></h4>
										<div class="info-product-price">
		...
		<div class="col-md-9 footer-right">
			<div class="sign-grds">
				...
				<div class="col-md-3 sign-gd flickr-post">
					...
					<ul>
						<li><a href="/single"><img src="images/t1.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="/single"><img src="images/t2.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="/single"><img src="images/t3.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="/single"><img src="images/t4.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="/single"><img src="images/t1.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="/single"><img src="images/t2.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="/single"><img src="images/t3.jpg" alt=" " class="img-responsive" /></a></li>
						<li><a href="/single"><img src="images/t2.jpg" alt=" " class="img-responsive" /></a></li>
